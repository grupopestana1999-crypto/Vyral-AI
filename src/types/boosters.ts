...
export const BOOSTERS: BoosterDef[] = [
  ...
  // 06 - Creator+
  {
    ...
    videoUrl: 'https://mdueuksfunifyxfqpmdv.supabase.co/storage/v1/object/public/public-media/boosters/video%20do%20BOOSTER%20=%20pele.mp4',
    credits: 4,
    tool: 'skin_enhancer',
  ...
  // 07 - Starter+
  {
    ...
    videoUrl: 'https://mdueuksfunifyxfqpmdv.supabase.co/storage/v1/object/public/public-media/boosters/video%20do%20BOOSTER%20=%20video%20ia.mp4',
    credits: 2,
    pricingHint: '2cr/s',
    tool: 'grok_video',
  ...
  // 09 - Starter+
  {
    ...
    videoUrl: 'https://mdueuksfunifyxfqpmdv.supabase.co/storage/v1/object/public/public-media/boosters/video%20do%20BOOSTER%20=%20sora%20remover.mp4',
    credits: 20,
    tool: 'sora_remover',
  ...
  // 10 - Pro · Em manutenção até cliente fazer upgrade Elevenlabs (Free Tier bloqueia chamadas de servidor).
  {
    ...
    videoUrl: 'https://mdueuksfunifyxfqpmdv.supabase.co/storage/v1/object/public/public-media/boosters/video%20do%20BOOSTER%20=%20clonagem%20de%20voz.mp4',
    credits: 5,
  ...
  // 11 - Starter+
  {
    ...
    videoUrl: 'https://mdueuksfunifyxfqpmdv.supabase.co/storage/v1/object/public/public-media/boosters/video%20do%20BOOSTER%20=%20transcricao.mp4',
    credits: 2,
